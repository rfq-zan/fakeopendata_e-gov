{{-- This will be the main page for managing users --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="#" class="flex items-center px-4 py-2 text-white rounded-lg bg-violet-600 hover:bg-violet-700">
                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 11a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1v-1z" /></svg>
                Add New User
            </a>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            <div class="mb-4">
                <input type="text" placeholder="Search users by name or email..." class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500">
            </div>
            <table class="w-full text-left">
                ...
                <tbody>
                    <tr class="border-b hover:bg-gray-50">
                        <td class="px-4 py-3">Rielf</td>
                        <td class="px-4 py-3">rifqirazzan09@gmail.com</td>
                        <td class="px-4 py-3"><span class="px-2 py-1 text-xs font-semibold rounded-full text-violet-800 bg-violet-200">Admin</span></td>
                        <td class="px-4 py-3 text-sm text-gray-600">2005-02-12</td>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">Unknown@example.com</td>
                        <td class="px-4 py-3"><span class="px-2 py-1 text-xs font-semibold text-gray-800 bg-gray-200 rounded-full">User</span></td>
                        <td class="px-4 py-3 text-sm text-gray-600">2025-05-21</td>
                        <td class="px-4 py-3 text-right">
                            <a href="#" class="text-violet-600 hover:underline">Edit</a>
                            <a href="#" class="ml-4 text-red-600 hover:underline">Delete</a>
                        </td>
                     ...
                     <tr class="border-b hover:bg-gray-50">
                        <td class="px-4 py-3">Anon</td>
                        <td class="px-4 py-3">Anon@example.com</td>
                        <td class="px-4 py-3"><span class="px-2 py-1 text-xs font-semibold text-gray-800 bg-gray-200 rounded-full">User</span></td>
                        <td class="px-4 py-3 text-sm text-gray-600">2025-08-02</td>
                        <td class="px-4 py-3 text-right">
                            <a href="#" class="text-violet-600 hover:underline">Edit</a>
                            <a href="#" class="ml-4 text-red-600 hover:underline">Delete</a>
                        </td>
