            ...
            <div class="container px-4 mx-auto">
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="flex flex-col transition-shadow border rounded-lg shadow-sm bg-card text-card-foreground hover:shadow-lg hover:border-secondary/50">
                        ...
                        <div class="flex gap-2 p-6 pt-0">
                            <a href="/download" class="inline-flex items-center justify-center flex-1 px-4 py-2 text-sm font-medium transition-colors rounded-md bg-secondary text-secondary-foreground hover:bg-secondary/90">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
